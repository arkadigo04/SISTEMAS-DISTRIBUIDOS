...
public class FaqController {
    ...
    public ResponseEntity<Map<String, String>> preguntarOak(@RequestBody Map<String, String> request) {
        ...
        try {
            // Forma segura de construir el JSON. Evita que comillas o caracteres raros rompan la petición.
            ...
            // Chivato en la terminal para depurar el error real
            System.err.println("❌ ERROR AL LLAMAR A LA IA DE GEMINI: " + e.getMessage());
            return ResponseEntity.ok(Map.of("respuesta", "Vaya... parece que el PC de mi laboratorio ha perdido la conexión. ¡Inténtalo más tarde!"));
        }
    }
}